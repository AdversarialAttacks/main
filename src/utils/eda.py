...
class ExplorativeDataAnalysis:
    def __init__(self, datamodule, image_size, batchsize, adversarial_matrix=None, dataloader_type="train"):
        ...
        self.data = datamodule(transform=self.transform, batch_size=self.batchsize, train_shuffle=True, seed=42).setup()
